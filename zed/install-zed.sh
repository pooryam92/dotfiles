...
# stack (WezTerm, zsh, Starship, zoxide, Neovim, Claude Code, the Nerd Font…);
...
info "Config is linked by install.sh (zed/settings.json, zed/keymap.json). See docs/zed.md."
