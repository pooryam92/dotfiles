...
Provide a spaced-repetition drill system that helps the maintainer learn and retain
the features of their daily-driver terminal tools through short, self-graded practice
sessions, with a single cross-platform runner and an unobtrusive due-only nudge at
shell start.
